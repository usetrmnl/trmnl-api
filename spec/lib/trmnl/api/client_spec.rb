...
RSpec.describe TRMNL::API::Client do
  ...
  describe "#firmware_latest" do
    let :endpoints do
      {firmware_latest: class_double(TRMNL::API::Endpoints::Firmware::Latest, new: instance)}
    end

    let(:instance) { instance_spy TRMNL::API::Endpoints::Firmware::Latest }
